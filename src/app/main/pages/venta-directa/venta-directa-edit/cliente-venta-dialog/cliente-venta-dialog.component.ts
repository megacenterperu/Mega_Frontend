...
@Component({
  selector: 'ms-cliente-venta-dialog',
  templateUrl: './cliente-venta-dialog.component.html',
  styleUrls: ['./cliente-venta-dialog.component.scss']
})
export class ClienteVentaDialogComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ClienteVentaDialogComponent>, @Inject(MAT_DIALOG_DATA) public data: any
  ) { }
