...
@Component({
  selector: 'ms-usuario-admin-rol-asignar',
  templateUrl: './usuario-admin-rol-asignar.component.html',
  styleUrls: ['./usuario-admin-rol-asignar.component.scss']
})
export class UsuarioAdminRolAsignarComponent implements OnInit {
